      ...
      res.send(`
        ...
        <html>
          ...
          <body>
            <div class="container">
              <div class="content">
                <img src="${process.env.APP_URL || ''}/Hx-logo.webp" alt="HX Logo" class="logo-img">
                <h1>Hx™</h1>
                ...
                <div class="download-section">
                  <div class="download-buttons">
                    <a href="https://apps.apple.com/us/app/hx-thermostat/id1105092523" class="download-btn">
                      Download on iOS
                    </a>
                    <a href="https://play.google.com/store/apps/details?id=com.jci.RIPL" class="download-btn android">
                      Get it on Android
                    </a>
                  </div>
                </div>
                
                <p class="footer-text">The HX API is running smoothly</p>
              </div>
            </div>
          </body>
        </html>
